...
import { demoStore, type ExpenseGroupMatch } from '@/lib/demoStore'
import { isDemo, DEMO_UID } from '@/lib/config'
import type { ChatMessage, ChatRole, Expense, MessageMeta, NewExpense } from '@/types'

export type { ExpenseGroupMatch }

export type ListOpts = { from?: string; to?: string; category?: string }
...
export async function expensesList(opts: ListOpts = {}): Promise<Expense[]> {
